...
public class Environment {
    ...
    /**
     * Remove a Thing (do not apply to Creatures). For Creatures, use removeCreature.
     *
    ...
    /**
     * *******************************************************************************
     * ATTENTION:::: Currently, the game dos not support deletion of creatures during the simulation. Many methods use the index of the Creature in the cpool and therefore it is not supposed to change
     * once the game is started. The purpose of this method is to help the setup of the environment before the start of the simulation!
     * ******************************************************************************
     */

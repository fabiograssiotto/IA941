...
public class World {
    ...
    public synchronized int[] getDestination() throws CommandExecException {
        StringTokenizer st = CommandUtility.sendGetDestination();
        ...
        if (st.hasMoreTokens()) {
            ...
            Logger.logErr("Error: missing Destination X");
            return arr;
        }
        ...
        if (st.hasMoreTokens()) {
            ...
            Logger.logErr("Error: missing Destination Y");
            return arr;
        }
        return arr;
    }

    public synchronized void setDestination(int x, int y) throws CommandExecException {
        CommandUtility.sendSetDestination(x, y);
    }

    /**
     * Get the World's width and height and also the position (xDS, yDS) of the DeliverySpot.
     *
     ...
     *
     * @return list of all entities (creatures, food, jewel and bricks) that exist in the world
     *
     * @throws CommandExecException An exception is thrown in case of missing or invalid parameter
     */
